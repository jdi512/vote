 ...
 * Generated at: 2023-12-20 11:48:54 UTC
...
public final class elect_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("				<li class=\"breadcrumb-item active\" aria-current=\"page\">당선인</li>\r\n");
      out.write("			</ol>\r\n");
      out.write("	</nav>\r\n");
      ...
      out.write("	//당선인 출력(국회의원 비례대표 아닐 때)\r\n");
      out.write("	if(code != 7 && code != 8 && code != 9){\r\n");
      out.write("		$.ajax({\r\n");
      out.write("			type: 'get',\r\n");
      out.write("			url: 'https://apis.data.go.kr/9760000/WinnerInfoInqireService2/getWinnerInfoInqire?serviceKey='+key+'&sgId='+id+'&sgTypecode='+code+'&sdName='+city+'&sggName='+district,\r\n");
      out.write("			data: {\r\n");
      out.write("				numOfRows: 20,\r\n");
      out.write("				pageNo: 1,\r\n");
      ...
      out.write("				list += '선거구명:' + data.response.body.items.item[i].sggName + '<br>';\r\n");
      out.write("				list += '이름:' + data.response.body.items.item[i].name + '('+ data.response.body.items.item[i].hanjaName +')' + '<br>';\r\n");
      out.write("				list += '최종학력:' + data.response.body.items.item[i].edu + '<br>';\r\n");
      out.write("				list += '직업:' + data.response.body.items.item[i].job + '<br>';\r\n");
      out.write("				list += '정당명:' + data.response.body.items.item[i].jdName + '<br>';\r\n");
      out.write("				list += '득표수(득표율):' + data.response.body.items.item[i].dugsu + ' ('+data.response.body.items.item[i].dugyul+'%)<br>'\r\n");
      out.write("				list += '경력:' + data.response.body.items.item[i].career1 +'<br>'+ data.response.body.items.item[i].career2 + '<br>';\r\n");
      out.write("				list += '<br>';\r\n");
      out.write("				}\r\n");
      out.write("				$(\".list\").append(list);\r\n");
      out.write("			}\r\n");
      out.write("		});\r\n");
      out.write("		//국회의원 비례대표일 때\r\n");
